...
export default function Home() {
  return (
    <div className="bg-gren-300 mx-24 h-[200vh]">
      <div className="mt-8 flex justify-between border border-green-100 hover:border-green-400 rounded-3xl py-3  px-9 w-2/4  font-bold transition ease-in-out duration-1000 sticky top-2 backdrop-blur-sm ml-64">
